...
/**
 * Trabajo en equipo con Marisol Rodriguez, y Patricia Rojas
...
/**
 * método traer usuario a partir del email, retorna usuario
 * @param email
 * @return 
 */
    ...
    /**
     * metodo validar si existe email y password registrado en base de datos
     *
     * @param email
     * @param password
     * @return
